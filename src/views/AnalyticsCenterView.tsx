...
export function AnalyticsCenterView({ data, user, mode, onNavigate }: AnalyticsCenterViewProps) {
  ...
  const overview = (
    <>
      <section className="metric-grid two-columns">
        ...
        <article className="metric-card tone-penalty"><span>Offene Rückmeldungen</span><strong>{analytics.openFeedback}</strong><small>{analytics.feedbackQuote}% Feedbackquote</small></article>
  ...
  const coachView = (
    <section className="section-block">
      ...
      <div className="calendar-list">
        ...
        }) : <p className="empty-state">Noch keine Sportler für die Coach Analyse.</p>}
      </div>
    </section>
  );
  ...
  const adminView = (
    <section className="metric-grid two-columns">
      ...
      <article className="metric-card tone-penalty"><span>Offene Rückmeldungen</span><strong>{analytics.openFeedback}</strong><small>plattformweit geladen</small></article>
    </section>
  );

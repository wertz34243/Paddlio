...
Diese Matrix beschreibt die Mindestpruefung vor einer externen Beta. Produktive Daten werden nicht fuer Tests verwendet.

| Bereich | Admin | ClubAdmin | Coach | Athlete | Fremder Verein | Zwei Geraete | Offline/Online |
|---|---|---|---|---|---|---|---|
...
| Training sehen | alles | eigener Verein | eigene Gruppen | eigene Plaene | nein | Reload stabil | lokal lesbar |
| Training loeschen | alles | eigener Verein | eigene Plaene | eigene freie Eintraege | nein | verschwindet beidseitig | Tombstone/Queue |
...
| Import | alles | Vereinsdaten | Trainings/Gruppen nach Recht | eigene Daten falls freigegeben | nein | Historie stabil | kein Import ohne Bestaetigung |
...
1. Coach erstellt Training fuer Athlete.
2. Athlete sieht Training am richtigen Datum.
3. Athlete markiert Training als durchgefuehrt und schreibt Feedback.
4. Coach sieht Feedback und antwortet.
5. Coach loescht Training.
6. Beide Geraete laden neu.
7. Training bleibt geloescht, Feedback/Nachrichten bleiben konsistent.

...
Version 0.1 wird als React-App mit Vite, TypeScript und CSS umgesetzt. Daten werden über einen kleinen Storage-Layer in LocalStorage gehalten und initial mit Tobias' Beispieldaten befüllt.

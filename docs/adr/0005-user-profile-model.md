...
Version 0.5 führt ein `User`-Modell mit `UserProfile` ein. Aktuell gibt es einen aktiven Nutzer über `activeUserId`, aber die Datenstruktur speichert bereits `users[]`, damit später mehrere Profile angelegt werden können.
